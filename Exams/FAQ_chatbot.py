...
Original file is located at
    https://colab.research.google.com/drive/1REXDB-vQUuQqZj3qpC83spcm1OJpIdlF
"""
...
# Vectorization on the FAQ questions
...
def get_faq_answer(question):
  ...
  if max_score >= 0.5: # Kept 0.5 as threshold so that it can even match single word question like: "Policy?"
    return best_answer
  else:
